...
public:
    ...
    struct OrgEntry {
        ...
        {1<<10,  64, {0, 0, 4,  2, 1<<14, 1<<(6+1)}},  // HBM_2Gb_PC
        {2<<10,  64, {0, 0, 4,  4, 1<<14, 1<<(6+1)}},  // HBM_4Gb_PC
        {3<<10,  64, {0, 0, 4,  4, 3<<13, 1<<(6+1)}},  // HBM_6Gb_PC
        {4<<10,  64, {0, 0, 4,  4, 1<<15, 1<<(6+1)}},  // HBM_8Gb_PC
        {4<<10,  64, {0, 0, 8,  4, 1<<14, 1<<(6+1)}},  // HBM_8Gb_8High_PC
        {6<<10,  64, {0, 0, 12, 4, 1<<14, 1<<(6+1)}},  // HBM_8Gb_12High_PC
        {6<<10,  64, {0, 0, 8,  4, 3<<13, 1<<(6+1)}},  // HBM_12Gb_8High_PC
        {9<<10,  64, {0, 0, 12, 4, 3<<13, 1<<(6+1)}},  // HBM_12Gb_12High_PC
        {8<<10,  64, {0, 0, 8,  4, 1<<15, 1<<(6+1)}},  // HBM_16Gb_8High_PC
        {12<<10, 64, {0, 0, 12, 4, 1<<15, 1<<(6+1)}},  // HBM_16Gb_12High_PC
    }, org_entry;
